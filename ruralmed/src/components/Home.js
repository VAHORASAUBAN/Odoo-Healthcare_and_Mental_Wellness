  ...
  return (
    ...
    <main className="main" id="top">
      <nav className="navbar navbar-expand-lg navbar-light fixed-top py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
        <div className="container"><a className="navbar-brand" href="index.html"><img src="assets/img/gallery/logo.png" width="118" alt="logo" /></a>
...
{/* 
      ...
      <section className="bg-secondary">
        <div className="bg-holder bg-size" style={{backgroundImage:'url(assets/img/gallery/bg-eye-care.png)',backgroundPosition:'top center',backgroundSize:'contain'}}>
...
{/* 
      ...
      <section className="py-8">
        ...
        <div className="bg-holder bg-size" style={{backgroundImage:'url(assets/img/gallery/people-bg-1.png)',backgroundPosition:'top center',backgroundSize:'contain'}}>
        </div>
        {/* <!--/.bg-holder--> */}
      ...
      <section className="py-8">
        <div className="container">
          <div className="row">
            ...
            <div className="bg-holder bg-size" style={{backgroundImage:'url(assets/img/gallery/dot-bg.png)',backgroundPosition:'top center',backgroundSize:'contain'}}>
            </div>
            {/* <!--/.bg-holder--> */}
            ...
            <div className="col-lg-6 z-index-2">
              <form className="row g-3">
                <div className="col-md-6">
                  <label className="visually-hidden" for="inputName">Name</label>
                  <input className="form-control form-RuralMed-control" id="inputName" type="text" placeholder="Name" />
                </div>
                <div className="col-md-6">
                  <label className="visually-hidden" for="inputPhone">Phone</label>
                  <input className="form-control form-RuralMed-control" id="inputPhone" type="text" placeholder="Phone" />
                </div>
                <div className="col-md-6">
                ...
                <div className="col-md-6">
                  <label className="form-label visually-hidden" for="inputEmail">Email</label>
                  <input className="form-control form-RuralMed-control" id="inputEmail" type="email" placeholder="Email" />
                </div>
                <div className="col-md-12">
                  <label className="form-label visually-hidden" for="validationTextarea">Message</label>
                  <textarea className="form-control form-RuralMed-control" id="validationTextarea" placeholder="Message" style={{height: '250px', required:"required"}}></textarea>
                </div>
      ...
      <section className="bg-primary">
        ...
        <div className="bg-holder bg-size" style={{backgroundImage:'url(assets/img/gallery/cta-bg.png)',backgroundPosition:'top center',backgroundSize:'contain'}}>
        </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6">
              ...
              <p className="text-soft-primary">RuralMed was created in order to improve the patient experience. <br />Providing world-className tests, and a wide range of other services.</p>
            </div>
            <div className="col-lg-6">
              ...
              <form className="row gx-2 gy-2 align-items-center">
                <div className="col">
                  <div className="input-group-icon">
                    ...
                    <input className="form-control form-RuralMed-control form-cta-control text-soft-primary" id="inputEmailCta" type="email" placeholder="Email" />
                  </div>
                </div>
            ...
            <div className="row justify-content-md-between justify-content-evenly py-4">
              ...
              <div className="col-12 col-sm-8 col-md-6">
                <p className="fs--1 my-2 text-center text-md-end text-200"> Made with&nbsp;
                  ...
                  </svg>&nbsp;by&nbsp;<a className="fw-bold text-info" href="https://themewagon.com/" target="_blank">ThemeWagon </a>
                </p>
              </div>
            </div>
          </div>
